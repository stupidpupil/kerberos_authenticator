...
describe KerberosAuthenticator::Krb5::Keytab do
  ...
  describe 'when I try to create a Keytab with a type of FILE and a path' do
  ...
  describe 'when I try to create a Keytab with a type of FILE and a UTF-8 path' do
    it 'must return a Keytab with that name' do
      KerberosAuthenticator::Krb5::Keytab.new_with_name('FILE:/итд/krb5.keytab').name.should.match /\/итд\/krb5.keytab$/
    end
  end

  describe 'when I try to create a Keytab with a nonsensical type' do
